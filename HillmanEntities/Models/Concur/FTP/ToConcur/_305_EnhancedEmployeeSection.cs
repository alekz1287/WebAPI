...
{
    /// <summary>
    /// Enhanced Expense Primary employee information
    /// </summary>
    public class _305_EnhancedEmployeeSection : ConcurImportFileSection
    {
        private const string TRANSACTION_TYPE = "305";
        private const int NUMBER_OF_COLUMNS = 137;
        private const string EMAIL_DOMAIN = "@hillmangroup.com";
        private const string DEFAULT_PASSWORD = "welcome";
        public ICollection<_305_EnhancedEmployeeRecord> Employee_Records { get; set; }


        public _305_EnhancedEmployeeSection(ICollection<Employee> employees) : base(TRANSACTION_TYPE, NUMBER_OF_COLUMNS)
        {
            Employee_Records = new List<_305_EnhancedEmployeeRecord>();
            foreach (Employee emp in employees)
            {
                Employee_Records.Add(Mapper.Map<_305_EnhancedEmployeeRecord>(emp));
            }
        }       
        ...
        {
            EnhancedEmployeeImportFile_Validator validator = new EnhancedEmployeeImportFile_Validator();
        ...
        {
            return base.SerializeSection<_305_EnhancedEmployeeRecord>(Employee_Records);
        }
    }
    ...
    /// </summary>
    public class EnhancedEmployeeImportFile_Validator : AbstractValidator<_305_EnhancedEmployeeSection>
    {
        public EnhancedEmployeeImportFile_Validator()
        {
            RuleForEach(x => x.Employee_Records).SetValidator(new Employee305_Validator());
            //RuleFor(x => x.Employee_Records).SetCollectionValidator(new Employee305_Validator());
        }
    }
    ...
    /// </summary>
    public class _305_EnhancedEmployeeRecord
    {
        [FtpFieldAttribute(2)]
    ...
    /// </summary>
    public class Employee305_Validator : AbstractValidator<_305_EnhancedEmployeeRecord>
    {
        public Employee305_Validator()
        {
